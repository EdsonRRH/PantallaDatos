      ...
      body: Center(
        ...
        children: [
          ...
          ElevatedButton(
              ...
              onPressed: () {
                final route = MaterialPageRoute(
                  builder: (context) => const QuaterPage(),
                );
                Navigator.push(context, route);
              }),
          SizedBox(height: 5.0),
...
//ES PARA LA TERCERA PANTALLA
class QuaterPage extends StatelessWidget {
  const QuaterPage({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
